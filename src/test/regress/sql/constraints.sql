...
COPY COPY_TBL FROM '/.automount/genh/h/i2/pidur072/postgresql-8.1.4/src/test/regress/data/constro.data';

SELECT '' AS two, * FROM COPY_TBL;

COPY COPY_TBL FROM '/.automount/genh/h/i2/pidur072/postgresql-8.1.4/src/test/regress/data/constrf.data';
